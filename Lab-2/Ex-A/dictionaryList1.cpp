...
ostream& operator <<(ostream& COUT, DictionaryList& D12)
{
  for (D12.go_to_first(); D12.cursor_ok(); D12.step_fwd())
    COUT << D12.cursor_key() << "  " << D12.cursor_datum() << endl;
  return COUT;
}
